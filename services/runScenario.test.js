...
describe('Puppeteer testing suite', () => {
  ...
  //       page.waitForSelector('img[data-qa="portrait-img"]', { timeout: 10000 }); // should already be here
  ...
  describe('Multiple Scenarios',  () => {
    it('Should properly load and execute set of scenarios', async () => {
      ...
      const purchase_select_product = require('./scenario/purchase-select-product');
